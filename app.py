...
def admin_listar_registros(id):
    ...
    registros_irregulares = Registro.get_all_weird_from_trabajador(trabajador)
    registros_correctos = Registro.get_all_good_from_trabajador(trabajador)
